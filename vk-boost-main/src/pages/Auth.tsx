      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl p-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <span className="font-bold text-xl tracking-tight">VKBoost</span>
          </div>

          <h1 className="text-2xl font-bold text-center mb-2">Добро пожаловать</h1>
          <p className="text-muted-foreground text-center text-sm mb-8">
            Войдите через Google, чтобы начать продвижение
          </p>

          <button
            onClick={signInWithGoogle}
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl border border-border bg-secondary hover:bg-secondary/80 text-foreground font-medium text-sm transition-all duration-200 hover:border-primary/30 active:scale-[0.98]"
          >
            <GoogleIcon />
            Войти через Google
          </button>
